...
****parallel and direct arguments do a path load( faster comparitive to normal table load )*****
...
sqlldr USERNAME/PASSWORD@DATABASE_NAME control=dc_data_load.ctl parallel=true direct=true
exit sqlldr